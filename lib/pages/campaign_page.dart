            ...
            children: [
                            ...
                            InkWell(
                                onTap: () {
                                  Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                      builder: (context) =>
                                          const CampaignNotificationPage(),
                                    ),
                                  );
                                },
                                child: const Icon(
              ...
              Positioned(
                  ...
                  child: Padding(
                    ...
                    child: Image.asset(kCampaignTitleImage),
                  )
                  // Column(
                  ...
                  //     ),
                  //     Text(
                  //       AppLocalizations.of(context)!.enjoyTheMoment,
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: ListView.builder(
                              itemCount: bloc.campaignLists.length,
                                    ...
                                    onTap: () => Navigator.of(context).push(
                                        MaterialPageRoute(
                                            builder: (builder) =>
                                                CampaignDetailsPage(
                                                  campaignId: bloc
                                                      .campaignLists[index].id,
                                                ))),
                                    child: CampaignListItem(
                                      campaignData: bloc.campaignLists[index],
                                    ));
                              }),
                        )
                      ],
