      ...
      child: Scaffold(
        ...
        body: Selector<CampaignDetailBloc,bool?>(
          selector: (_,bloc)=> bloc.isLoading,
           ...
           loading == true ? const  LoadingView(indicator: Indicator.ballSpinFadeLoader, indicatorColor: kPrimaryColor) :
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    CachedNetworkImageView(
                        ...
                        imageUrl: bloc.campaignDetail?.product?.image ?? ''
                            ),
                    const SizedBox(
                      height: kMargin30,
                    ),
                Text(
                    ...
                    Container(
                      ...
                      child:  Row(
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: (){
                              Navigator.of(context).push(MaterialPageRoute(builder: (_)=> CampaignParticipantPage(campaignId: bloc.campaignDetail?.id ?? 0,)));
                            },
                            child: ImageStack(
                              imageList: bloc.images.length > 3 ? bloc.images.take(3).toList() :bloc.images,
                              imageRadius: 30,
                              imageCount: 3,
                              imageBorderWidth: 3,
                              totalCount:  bloc.campaignDetail?.joinedUsers?.length ?? 0,
                    ...
                    const SizedBox(
                     ...
                     Text(
                        bloc.campaignDetail?.description ?? '')
                  ],
                ),
              ),
                       ),
            ...
            child: Center(
              child: Row(
                ...
                children: [
                  ...
                  InkWell(
                    onTap: () => bloc.joinCampaign().then((_){
