...
class TicketBloc extends ChangeNotifier {
  ...
  void onTapCreateTicket(BuildContext context) {
    ...
    showModalBottomSheet(
      ...
      isScrollControlled: true, // To handle keyboard overflow for text fields
      builder: (context) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                creatTicket(context, titleController.text, descriptionController.text);
              },
              style: ElevatedButton.styleFrom(
                backgroundColor: const Color(0xffFF8800), // Primary color for button
  ...
  void creatTicket(BuildContext context, String title, String description) async {
